...
public class HistoryModel {
	 ...
	 * 
	 * @param max
	 *            the maximum numbers of items this history can hold
	 */
	 ...
	 * 
	 * @param text
	 *            the string to be added to the history
	 */
	...
	/**
	 * When user press UP or DOWN, we need to get a previous typed string,
	 * stored in the <code>Vector</code>.
	 * 
	 * @param index
	...
	/**
	 * As the user can use arrows to get up and down in the list, we need to
	 * know its max capacity.
	 * 
