...
/**
 * <code>ConsoleTextPane</code> is the text area of JSource <code>Console</code>.
 * It is where the user types commands, and also where command outputs are displayed.
    ...
    public ConsoleTextPane(Console parent) {
        ...
        _mouseListener = new MouseAdapter() {
                    public void mousePressed(MouseEvent evt) {
                        evt.consume();
                        if (getCaretPosition()
                                < ConsoleTextPane.this.parent.getUserLimit())
