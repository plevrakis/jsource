...
/**
 * DefaultInputHandler.java	12/17/02
 *
...
/**
 * <code>DefaultInputHandler</code> is the default input handler. It maps sequences
 * of keystrokes into actions and inserts key typed events into the text area.
 * @author Slava Pestov
 * <br>Revised for JSource 2003 Panagiotis Plevrakis
 */
public class DefaultInputHandler extends InputHandler {

    private Hashtable bindings = null;
    private Hashtable currentBindings = null;
     ...
     * @param mainFrame the <code>MainFrame</code> host of the editor.
     */
    public DefaultInputHandler(MainFrame mainFrame) {
    ...
    /**
     * Handle a key released event. Used only to stop the <code>Timer</code> that
     * handles <code>Refresher</code> in the <code>MainFrame</code>.
     */
    ...
    public void keyTyped(KeyEvent evt) {
		if (mainFrame.currFile != null) {
			mainFrame.currFile.setFileModified(true);
