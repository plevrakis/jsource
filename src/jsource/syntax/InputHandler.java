...
/**
 * An <code>InputHandler</code> converts the user's key strokes into concrete actions.
 *
 * This class provides all the necessary support code for an input handler, but it does not
 * actually do any key binding logic. It is up to the implementations of this class to do so.
 *
 * @author Slava Pestov
 * @author Panagiotis Plevrakis - Revised for JSource 2003
 * <br>08/12/2002	Clipboard actions	(Oliver Henning)
 */
public abstract class InputHandler extends KeyAdapter {
     ...
     * @param evt The event
     */
    public static JSEditor getTextArea(EventObject evt) {
        if (evt != null) {
    ...
    public static class backspace implements ActionListener {
        public void actionPerformed(ActionEvent evt) {
            JSEditor textArea = getTextArea(evt);
    ...
    public static class home implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            int firstVisibleLine = (firstLine == 0
                    ? 0
    ...
    public static class insert_break implements ActionListener {
        public void actionPerformed(ActionEvent evt) {
            ...
            textArea.setSelectedText(JSConstants.LINE_SEP);
        }
    }
