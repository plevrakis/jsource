...
// 3/20/2001 Lee Meador Change to make tabs columns settable.

package com.tinyplanet.javaparser;

import com.tinyplanet.docwiz.*;
...
public final class ASCII_UCodeESC_CharStream
{
  ...
  private static ConfigurationService config = ConfigurationService.getConfigurationService();
  private int tabSize;
