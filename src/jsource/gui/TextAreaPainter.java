...
/**
 * <code>TextAreaPainter</code> is the repaint manager for a <code>JSEditor</code> object.
 *
 * Based on <code>TextAreaPainter</code> in jEdit syntax package.
 *
...
public class TextAreaPainter extends JComponent implements TabExpander {
    ...
    Token currentLineTokens = null;
    Segment currentLine = null;

    protected JSEditor textArea = null;

    protected SyntaxStyle[] styles = null;
    protected Color caretColor = null;
    protected Color selectionColor = null;
    protected Color lineHighlightColor = null;
    protected Color bracketHighlightColor = null;
    protected Color eolMarkerColor = null;

    protected boolean blockCaret = false;
    protected boolean lineHighlight = false;
    protected boolean bracketHighlight = false;
    ...
    protected Highlight highlights = null;

    /**
     * Creates a new repaint manager. This should not be called directly.
     */
    public TextAreaPainter(JSEditor textArea, TextAreaDefaults defaults) {
    ...
    public interface Highlight {
         ...
         */
        void init(JSEditor textArea, Highlight next);
    ...
    protected void paintCaret(Graphics gfx, int line, int y) {
        if (textArea.isCaretVisible()) {
            ...
            int caretWidth = ((blockCaret || textArea.isOverwriteEnabled())
                    ? fm.charWidth('w')
                    : 1);
